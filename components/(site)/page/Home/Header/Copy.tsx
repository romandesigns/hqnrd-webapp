...
export function Copy({ lang }: { lang: Locale }) {
  return (
    <div className="pt-8 text-center lg:text-left flex flex-col space-y-3 lg:items-start justify-center items-center px-3">
          ...
          <div>
            <div className="flex items-center justify-center gap-2">
              <NumberTicker
                value={4.5}
                decimalPlaces={2}
                className="text-sm font-bold tracking-tighter whitespace-pre-wrap text-black dark:text-white"
              />
      ...
      <h2 className="uppercase font-black text-2xl sm:text-4xl text-center lg:text-left leading-snug">
        Serenidad, comodidad e higiene <br className="hidden lg:inline-block" />{" "}
      ...
      <div className="flex justify-center space-x-4 mt-4 lg:mr-auto">
        ...
        <Button variant="bordered" className="h-10">
          Ver habitaciones
        </Button>
      </div>
