...
export function Gallery() {
  return (
    <div className="border dark:border-t-neutral-700 bg-background dark:bg-accent/50 aspect-video flex items-center justify-center p-1 rounded-md lg:p-4 relative">
